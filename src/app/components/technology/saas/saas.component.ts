...
export class SaasComponent implements OnInit {
  ...
  constructor(private meta: Meta, private pageTitle: Title) {
   this.meta.addTags([
     {name: 'description', content: 'FutureaAI Software provides By combining a broad range of technical expertise with an unparalleled commitment to customer satisfaction, FutureAI Soft has become an authoritative option for companies looking to develop SaaS applications of various levels of complexity.'},
