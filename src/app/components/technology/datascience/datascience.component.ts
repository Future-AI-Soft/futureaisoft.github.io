...
export class DatascienceComponent implements OnInit {
  ...
  serviceDesc = `With over 5 years of trip in Java Development and Dedication to Delivery excellence, FAISS has performed the easiest stage of technological know-how and area information in developing, testing, and retaining world-class Java Software Solutions custom-made uniquely to clients’ wishes and budget. `;
