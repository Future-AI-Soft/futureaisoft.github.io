...
export class DotnetComponent implements OnInit {
  ...
  serviceDesc = `Since .NET inception in early 2000s, FAISS has been supporting businesses and startups build, upgrade,
  ...
  servicesTitle = 'FAISS .NET Software Development Services'
  services = [
