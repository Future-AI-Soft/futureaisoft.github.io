...
export class ServicesComponent implements OnInit {
  ...
  @Input() description: string = `FAISS is a premier full-service Custom Software Development, Cloud Engineering, QA and DevOps
  company, specializing in the development of time-sensitive and innovative solutions. To every
  project, FAISS brings a combination of domain expertise, exceptional engineering talent, rigorous
