...
export class LandingComponent implements OnInit { 
  ...
  constructor(private meta: Meta, private title: Title) {
    this.meta.addTags([
      {name: 'description', content: 'Future AI Software and Solutions Ltd is an elementary Web Software Development Company that develops sophisticated and innovative solutions.'},
