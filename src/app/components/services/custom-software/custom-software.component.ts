...
export class CustomSoftwareComponent implements OnInit {
  ...
  description: string = `FAISS is a premier full-service Custom Software Development, Cloud Engineering, QA and DevOps company, specializing in the improvement of time-sensitive and revolutionary solutions. To each project, FAISS brings a aggregate of area expertise, extraordinary engineering talent, rigorous Agile improvement processes, dedication to safety of client’s IP and accountability of a US organization with over two many years of impeccable reputation.`;
  ...
  constructor(private meta: Meta, private pageTitle: Title) {
    this.meta.addTags([
      {name: 'description', content: 'FAISS is a Custom Software Development Company that develops sophisticated and innovative solutions.'},
